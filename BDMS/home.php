...
<br>
        ...
        <h2>Number of Donors Registered Of each Blood Group</h2>

        <div class="row">
          <?php
            include 'conn.php';
            $apvcountsql = "SELECT COUNT(*) FROM donor_details where donor_blood = 3";
            $bpvcountsql = "SELECT COUNT(*) FROM donor_details where donor_blood = 1";
            $anvcountsql = "SELECT COUNT(*) FROM donor_details where donor_blood = 6";
            $bnvcountsql = "SELECT COUNT(*) FROM donor_details where donor_blood = 2";
            $abpvcountsql = "SELECT COUNT(*) FROM donor_details where donor_blood = 7";
            $abnvcountsql = "SELECT COUNT(*) FROM donor_details where donor_blood = 8";
            $opvcountsql = "SELECT COUNT(*) FROM donor_details where donor_blood = 4";
            $onvcountsql = "SELECT COUNT(*) FROM donor_details where donor_blood = 5";

            $apvrs = mysqli_query($conn,$apvcountsql);
            $bpvrs = mysqli_query($conn,$bpvcountsql);
            $opvrs = mysqli_query($conn,$opvcountsql);
            $abpvrs = mysqli_query($conn,$abpvcountsql);
            $anvrs = mysqli_query($conn,$anvcountsql);
            $bnvrs = mysqli_query($conn,$bnvcountsql);
            $onvrs = mysqli_query($conn,$onvcountsql);
            $abnvrs = mysqli_query($conn,$abnvcountsql);
          

          //-----------^  need to run query here

             $apvcountresult = mysqli_fetch_array($apvrs);
             $bpvcountresult = mysqli_fetch_array($bpvrs);
             $opvcountresult = mysqli_fetch_array($opvrs);
             $abpvcountresult = mysqli_fetch_array($abpvrs);
             $anvcountresult = mysqli_fetch_array($anvrs);
             $bnvcountresult = mysqli_fetch_array($bnvrs);
             $onvcountresult = mysqli_fetch_array($onvrs);
             $abnvcountresult = mysqli_fetch_array($abnvrs);
           ...
           &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
            ...
            <div class="card" style="width:300px">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">
                    <b>A+&nbsp &nbsp  : </b> <b><?php echo $apvcountresult[0]; ?></b><br>
                    <b>B+&nbsp &nbsp  : </b> <?php echo $bpvcountresult[0]; ?><br>
                    <b>AB+ : </b><?php echo $abpvcountresult[0]; ?><br>
                    <b>O+&nbsp&nbsp  : </b> <?php echo $opvcountresult[0]; ?><br>
        ...
        <div class="col-lg-4 col-sm-6 portfolio-item" ><br>
            <div class="card" style="width:300px">
                ...
                <div class="card-body">
                  <h3 class="card-title"><?php echo $row['donor_name']; ?></h3>
                  <p class="card-text">
                    <b>A-&nbsp &nbsp  : </b> <b><?php echo $anvcountresult[0]; ?></b><br>
                    <b>B-&nbsp &nbsp  : </b> <?php echo $bnvcountresult[0]; ?><br>
                    <b>AB- : </b><?php echo $abnvcountresult[0]; ?><br>
                    <b>O-&nbsp&nbsp : </b> <?php echo $onvcountresult[0]; ?><br>
